...
var Demo1 = new Phaser.Class({
    ...
    function() {
        ...
        // Transition to scene "Demo2" on click
        this.input.once(
            'pointerup',
            function() {
...
var Demo2 = new Phaser.Class({
    ...
    function() {
        ...
        // Add "invisible" planet
        var planet = this.add.image(halfW, halfH, 'planet');
        planet.setScale(0);
        ...
        // Transition to scene "Demo3" on click
        this.input.once(
            'pointerup',
            function(event) {
...
var Demo3 = new Phaser.Class({
    ...
    function() {
        ...
        // Transition to scene "Demo1" on click
        this.input.once(
            'pointerup',
            function(event) {
